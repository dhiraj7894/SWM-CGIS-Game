...
public class dryWaste : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    //3. if dustbin is any of other than Dry-Waste then place the garbadge position initial.
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        // if garbadge is on Dry-Waste dustbin
        ...
        else if (eventData.pointerEnter.name == "EWST" || eventData.pointerEnter.name == "WWST" || eventData.pointerEnter.name == "SnHWST")
        {
            chanceData--;
