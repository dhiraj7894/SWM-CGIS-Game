...
public class SanNHazWaste : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    //3. if dustbin is any of other than SnH-Waste then place the garbadge position initial.
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        // if garbadge is on E-Waste dustbin
        ...
        else if (eventData.pointerEnter.name == "EWST" || eventData.pointerEnter.name == "WWST" || eventData.pointerEnter.name == "DWST")
        {
            chanceData--;
